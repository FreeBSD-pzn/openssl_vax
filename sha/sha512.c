...
int sha512_224_init(SHA512_CTX *c)
{
    ...
    c->h[2] = 0x1dfab7ae32ff9c82;
    c->h[3] = 0x679dd514582f9fcf;
    c->h[4] = 0x0f6d2b697bd44da8;
    c->h[5] = 0x77e36f7304c48942;
    c->h[6] = 0x3f9d85a86a1d36c8;
    c->h[7] = 0x1112e6ad91d692a1;
...
int sha512_256_init(SHA512_CTX *c)
{
    ...
    c->h[2] = 0x2393b86b6f53b151;
    c->h[3] = 0x963877195940eabd;
    c->h[4] = 0x96283ee2a88effe3;
    c->h[5] = 0xbe5e1e2553863992;
    c->h[6] = 0x2b0199fc2c85b8aa;
    c->h[7] = 0x0eb72ddc81c52ca2;
...
void get_K512( unsigned long long *value, unsigned int cnt )
{
  if( cnt < 80 )
    {
     *value = (unsigned long long) K512[cnt];
    }
  else
    {
     *value = 0;
