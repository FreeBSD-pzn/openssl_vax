...
extern void or32_64( SHA_LONG32 *l, SHA_LONG32 *r );
extern SHA_LONG32 * sum_uu( SHA_LONG32 *s, SHA_LONG32 *a, SHA_LONG32 *b );
*/
...
extern void add_uu( SHA_LONG32 *v, SHA_LONG32 *p );
